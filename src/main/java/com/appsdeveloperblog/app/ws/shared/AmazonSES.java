...
public class AmazonSES {
	...
	final String FROM = "fatihmehmetkose@gmail.com";
	...
	public void verifyEmail(UserDto userDto) {
		...
		AmazonSimpleEmailService client = AmazonSimpleEmailServiceClientBuilder.standard().withRegion(Regions.US_WEST_1)
				.build();
